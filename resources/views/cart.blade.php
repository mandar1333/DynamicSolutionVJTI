...
<div class="w-full absolute z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700 " id="checkout">
    <div class="w-full relative">
        <div class="flex items-center m-auto lg:flex-row flex-col justify-center" id="cart">
            <div class="  lg:w-1/2 md:w-8/12 w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white dark:bg-gray-800 overflow-y-hidden overflow-x-hidden lg:h-screen h-auto" id="scroll">
                ...
                <p class="lg:text-4xl text-3xl font-sans leading-10 text-gray-800 dark:text-white pt-3">Bag</p>
                <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                    ...
                    <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                        ...
                        <div class="flex items-center justify-between w-full pt-1">
                            <p class="text-base font-sans leading-none text-gray-800 dark:text-white">North wolf bag</p>
                        ...
                        <div class="flex items-center justify-between pt-5">
                            ...
                            <p class="text-base font-sans leading-none text-gray-800 dark:text-white">$9,000</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="lg:w-96 md:w-8/12 w-full bg-gray-100 dark:bg-gray-900 h-full">
                <div class="flex flex-col lg:h-screen h-auto lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between overflow-y-auto">
                    <div>
                        <p class="lg:text-4xl text-3xl font-sans leading-9 text-gray-800 dark:text-white">Summary</p>
